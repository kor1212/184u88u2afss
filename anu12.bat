@echo off
set version=1.8.1
title Xperience Tweaks - %version%
...
echo.
echo.
echo                                 %c%Xperience is a tweaking script that optimizes your system%u% 
...
echo.
echo.
echo %c%Xperience Tweaks is a tweaking script that optimizes your%u% 
...
echo %r%Xperience\Xperience Folder\Important - Read First.txt%u%
echo.
echo %g%======PRESS ANY KEY TO CONTINUE======
...
echo.
echo.
start https://github.com/Xperience/Xperience/releases
echo.
echo %g%======PRESS ANY KEY TO CONTINUE======
...
powershell Invoke-WebRequest "https://files.catbox.moe/0fztd7.pow" -OutFile "%temp%\Xperience_Tweaks.pow"
cls
powercfg /d 44444444-4444-4444-4444-444444444449 >nul 2>&1 
powercfg -import "%temp%\Xperience_Tweaks.pow" 44444444-4444-4444-4444-444444444449 >nul 2>&1 
powercfg -SETACTIVE "44444444-4444-4444-4444-444444444449" >nul 2>&1 
powercfg /changename 44444444-4444-4444-4444-444444444449 "Xperience's Power Plan" "The Ultimate Power Plan to increase FPS, improve latency and reduce input lag." >nul 2>&1 
del "%temp%\Xperience_Tweaks.pow"
echo.
echo %g%======PRESS ANY KEY TO CONTINUE======
...
echo.
echo %c%                       ╔══════════════════════════════════════════════════╗ %u%
echo                        %c%║%u%           [%c%1%u%] Xperience Toolbox                     %c%║%u% 
...
echo.
echo                                    - Thank you for using Xperience Toolbox! -
echo _______________________________________________________________________________________________________________________
echo.
echo                    ===========================================================================
echo                    " For Xperience Toolbox - please note that this is currently in development! "
echo                    ===========================================================================
echo                    ===========================================================================
echo                    "  Currently working on every Windows build. Please be aware of any bugs  "
echo                    ===========================================================================
echo.
echo                                     %r%Press any key to start Xperience Toolbox! %u%
pause >nul
...
:89
cls
title Xperience Tweaks - Toolbox
